...
import com.accidentaldeveloper.whatsapp.ChatDetailActivity;
import com.accidentaldeveloper.whatsapp.Models.Users;
import com.accidentaldeveloper.whatsapp.R;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.sample_show_user, parent, false); // made a view
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ImageView image;// brought all the widgets.
        TextView userName;
