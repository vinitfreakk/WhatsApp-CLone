...
import com.accidentaldeveloper.whatsapp.databinding.ActivitySettingsBinding;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //GALLERY SE IMAGE ACCESS KARNE K LIYE CODE;
        binding.plus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setAction(Intent.ACTION_GET_CONTENT);
                intent.setType("image/*"); // aur agar documents, videos kuch bhi dhekaha ho tho bhi same code for eg:- intent.setType("image/*video/*");
